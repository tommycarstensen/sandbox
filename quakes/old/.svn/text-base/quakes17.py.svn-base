#!/software/bin/python
#
#$Id: quakes.py,v 1.5 2007/09/07 16:03:49 tc Exp $
#
...
## what to do?! LIST THOSE DAMN CHEMICAL GROUPS!
## ATOM2seq will leave modified residues (ch2,eth,etc.) as gaps,
## because the standard residue and its chemical add-on (ch2,eth,etc.) rather than the modified residue is given in the SEQRES records

## compare TPO,SEP to phosphorylated THR,SER (e.g. 1atp.pdb)
...
##        self.gunzip()
        ...
        errorpdbs = [
            ...
            '1vwi','1vwj','1vwk','1vwl','1vwq','1vwr', ## HIS/LEA
            ## linkers
...
##            ]
##        ## different hetero compounds (mostly different saccharides) CONECT.txt
##        self.l_pdbs = ['1anf', '1axm', '1b3v', '1b3w', '1b3y', '1b3z', '1bfb', '1bfc', '1bos', '1byb', '1byc', '1c4q', '1cqe', '1cqf', '1crl', '1cvn', '1cxk', '1d1i', '1d1k', '1d3c', '1d6p', '1d6q', '1dtu', '1e4o', '1ehn', '1eib', '1eo5', '1eo7', '1eqh', '1ez9', '1f2q', '1f9d', '1fae', '1fbw', '1ffr', '1fqa', '1fqb', '1fqc', '1fqd', '1fzk', '1fzo', '1g94', '1g9f', '1g9h', '1gmn', '1gmo', '1gwl', '1h12', '1h3t', '1h3u', '1hew', '1i3h', '1i82', '1i8a', '1isv', '1isw', '1isx', '1itc', '1iw6', '1iw9', '1ixf', '1j0i', '1j0j', '1j0k', '1j0y', '1j0z', '1j18', '1j88', '1j89', '1js4', '1jw5', '1k9t', '1kck', '1l1y', '1l2a', '1l5w', '1l6i', '1lax', '1lmp', '1lmq', '1loh', '1lxk', '1lzb', '1lzc', '1lze', '1lzg', '1m18', '1m19', '1m1a', '1md9', '1mdb', '1mfb', '1mfc', '1mfv', '1mpn', '1mpo', '1mqm', '1mqn', '1n7r', '1nca', '1ncb', '1ncc', '1nh6', '1nm9', '1nws', '1nwt', '1nwu', '1ona', '1ot1', '1ot2', '1our', '1ovs', '1pez', '1q6c', '1q6d', '1q6e', '1q6f', '1q6g', '1q9q', '1q9r', '1q9t', '1qdo', '1qnw', '1qoo', '1qos', '1re2', '1rey', '1rez', '1rp9', '1rpk', '1sbf', '1sf4', '1sf6', '1sf7', '1sfb', '1sfg', '1sl4', '1sqy', '1sr0', '1syt', '1trh', '1ubz', '1ucq', '1uh4', '1uih', '1uks', '1ukt', '1ur1', '1ur2', '1usw', '1uu4', '1uu6', '1uy2', '1uy3', '1uy4', '1uza', '1v3h', '1v3i', '1v3l', '1v3m', '1v6w', '1v6x', '1vb9', '1vbo', '1vbp', '1vem', '1ven', '1veo', '1vep', '1vfk', '1vfm', '1vfo', '1vfu', '1w2u', '1w3k', '1w3l', '1w8u', '1wd4', '1wds', '1wu5', '1wu6', '1x0k', '1x0s', '1y1e', '1y1i', '1z32', '1zbk', '1zbv', '1zbw', '1zlu', '1zlv', '1zlw', '1zu8', '2aft', '2ar6', '2arb', '2av6', '2aw3', '2axm', '2b4f', '2bjj', '2bwa', '2bwc', '2c4a', '2c4l', '2c6p', '2civ', '2ciw', '2cnc', '2d0f', '2d0g', '2d0h', '2d22', '2d24', '2d3l', '2d3n', '2d43', '2dij', '2dp8', '2dpe', '2ds9', '2dsu', '2dsv', '2dsw', '2dsz', '2dt0', '2dt1', '2dt3', '2dwh', '2f9n', '2f9p', '2g41', '2gmm', '2gnb', '2hyu', '2hyv', '2it6', '2j18', '2j19', '2j1t', '2j1v', '2j72', '2j73', '2man', '2nwj', '2o1l', '2o92', '2oot', '2sba', '2uvh', '2uvj', '3cel', '3man', '3mbp', '3tf4', '4mbp', '4tf4', '5cel', '6cel', '7api', '7cel', '8api', '9api']
    ...
    def analyze_rmsd(self):
        ...
        for i in range(len(lines)/(n_lines)):
            ...
            if float(d_parameters['residues']) < 50:
                errorpdbs = set([
                    ...
                    '1p7i','1p7j',
                    ## overlap shorter than 50 but not an error
                    '1bx7','1bx8',
                    ...
                    if value not in ['NULL','N/A']:
                        ...
                        if (value < 50 or value > 303) and parameter == 'T':
                            errorpdbs = set([
                                ...
                                '1za1','1qtv','1khh','1cvm','1ez9','1ulx','2der',
                                ## correct (cryogen)
                                '2fbb','1j3y','1j41','1ajg','1ajh','1a6k','1c1g','2i16',
                                ## incorrect (celsius)
                                '1ade','1c0e',
                                ## remediation change
                                '1dos',
        ...
        for parameter in d_data_ratio_continuous.keys():
            for type in d_data_ratio_continuous[parameter]:
                ...
                fd.close()
                ## linear regression
                if type == 'difference': regression = True
                else: regression = False
                self.gnuplot_plot(prefix_gnuplot, regression=regression, errorbars=True)
        ...
        for parameter in d_data_ratio_discrete.keys():
            ...
            if parameter in ['chains','residues','coordinates']:
                logarithmic = True
            self.gnuplot_plot(prefix_gnuplot, regression=True, logarithmic=logarithmic, errorbars=True)
...
##            'set title "%s, %s\\njob: %s\\nchains: %s\\ndistance cutoff: %s{\305}" ,4\n' %(plotname, title1, jobid, chains, cutoff_distance),
        ...
        line_plot = 'plot "%s.gnuplotdata" lt 0 ps 2 pt 2' %(prefix)
        if errorbars == True:
            line_plot += ' w errorb'
        if regression == True:
            line_plot += ', f(x)'
                        ...
                        for pdbpair in pdbpairs:
                            ...
                            for roota in d_hetero[pdba].keys():
                                ...
                                for rootb in d_hetero[pdbb].keys():
                                    ...
                                    if compounda == compoundb: ## also compare the roots !!!
                                        identical = True
                                        break
                                if identical == False:
                                    different = True
...
##        print d_chains_interpdb_sequence_similar
    ...
    def ATOM2seq(self, d_pdb, chain, res_no_max = None):
...
## incorrect d_res_nos will be returned from ATOM2seq for 2bfk (vs 2bfl), chain A becauseof ASN61A in REMARK465 records!!!
        ...
        for i in range(len(res_nos)):
            ...
            for i in range(len(d_pdb['chains'][chain]['residues'][res_no]['l_iCodes'])):
                ...
                if res_name not in self.l_modres+self.l_nucleotides+self.d_res.keys():
                    continue
...
##        fd = open('%s%s.pdb' %(self.pdbpath, s_pdb.upper()),'r')
        ...
        if s_pdb not in d_pdb.keys():
            d_coordinates,d_heteromolecules = self.parse_pdbcoordinatesection(lines, s_pdb, d_seq)
...
#### count number of similar chains by comparing SEQRESseqs
    ...
    def parse_pdbcoordinatesection(self, lines, s_pdb, d_seq):
        ...
        for i in range(len(lines)):
            ...
            if record == 'ATOM':
                d_coordinates, d_line = self.parse_recordATOM(line, d_coordinates, lines, i, d_seq, s_pdb, 'ATOM')
                ...
                if res_name in ['HOH','H2O','DOD','D2O']:
                    d_coordinates, d_line = self.parse_recordATOM(line, d_coordinates, lines, i, d_seq, s_pdb, 'HETATM')
                        ...
                        for atom_no1 in d_CONECT[hetID1][chain1][res_no1][iCode1].keys():
                            ...
                            if len(d_CONECT[hetID1][chain1][res_no1][iCode1][atom_no1]['inter']) > 1:
                                if len(d_CONECT[hetID1][chain1][res_no1][iCode1][atom_no1]['inter']) == 2:
                                    ...
                                    if not (
                                        d_atomnos[tmpatom_no1]['res_name'] == d_atomnos[tmpatom_no2]['res_name'] and
                                    ...
                                    if atom_names-set(['OD1','OD2','OD3',]) != set(['SG']):
                                        print atom_names
                                        for atom_no in d_CONECT[hetID1][chain1][res_no1][iCode1][atom_no1]['inter']:
                            ...
                            ## check 2a
                            if atom_name1[-1] in ['A','B','H',"'"] and len(atom_name1) > 2 and hetID1 not in self.d_res.keys()+self.l_modres+self.l_linkers:
                                if hetID1 not in [
                                    ## pyranoses
                                    'XYP','G6D','SIA',
                                    'FCT',
                                    ...
                                    'GDP','DA','UMP','DC','C','PGD','DT','DC','BZG','8OG','ADP','A','TSP','CMP',
##                                    ## dinucleotides
##                                    'NAP',
                                    ]:
                                    print 'hetID', hetID1
                            ...
                            for atom_no2 in d_CONECT[hetID1][chain1][res_no1][iCode1][atom_no1]['inter']:
                                ...
                                ## check 2b
                                if atom_name2[-1] in ['A','B','H',"'"] and len(atom_name2) > 2 and hetID2 not in self.d_res.keys()+self.l_modres+self.l_linkers:
                                    if hetID2 not in [
                                        ## pyranoses
                                        'XYP','G6D','SIA',
                                        'FCT',
...
##                                        'NAP',
                                        ...
                                        print hetID2, atom_name2, d_CONECT[hetID2][chain2][res_no2][iCode2][atom_no2]
                                        print hetID2, hetID1
                                        stop
                                ...
                                if hetID1 in self.d_res.keys()+self.l_modres+self.l_linkers and hetID2 in self.d_res.keys()+self.l_modres+self.l_linkers:
                                    continue

                                if atom_name1[0] == 'C' and atom_name2[0] == 'C':
                                ...
                                ##
                                ## lysine, cysteine (e.g. palmitoylation), histidine, tryptophan
                                ##
                                elif (
                                    ...
                                    (hetID1 == 'HIS' and atom_name1 in ['ND1',] and atom_name2[0] == 'O') or
                                    (hetID1 == 'ASP' and atom_name1 in ['OD','OD1','OD2',])
                                    ):
                                    if hetID2 in self.d_saccharides.keys() and hetID1 not in ['ASP']:
                                        print hetID1, hetID2
                                        stop
                                    bond = atom_name1[0]+','+atom_name2[1:]
                                    monomer1 = chain1+str(res_no1).zfill(4)+iCode1
                                    monomer2 = chain2+str(res_no2).zfill(4)+iCode2
                                elif (
                                    ...
                                    (hetID2 == 'HIS' and atom_name2 in ['ND1',] and atom_name1[0] == 'O') or
                                    (hetID2 == 'ASP' and atom_name2 in ['OD','OD1','OD2',])
                                    ):
                                    if hetID1 in self.d_saccharides.keys() and hetID2 not in ['ASP']:
                                        print hetID1, hetID2
                                        stop
                                    bond = atom_name2[0]+','+atom_name1[1:]
                                    monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                    monomer1 = chain2+str(res_no2).zfill(4)+iCode2
                                ##
                                ## tyrosine adenylation (make more general solution for phosphodiester bonds)
                                ##
                                elif hetID1 == 'TYR' and atom_name1 == 'OH' and atom_name2 == 'P1':
                                    bond = 'O'+','+atom_name2
                                    monomer1 = chain1+str(res_no1).zfill(4)+iCode1
                                    monomer2 = chain2+str(res_no2).zfill(4)+iCode2
                                elif hetID2 == 'TYR' and atom_name2 == 'OH' and atom_name1 == 'P1':
                                    bond = 'O'+','+atom_name1
                                    monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                    monomer1 = chain2+str(res_no2).zfill(4)+iCode2
                                ##
                                ...
                                ##
                                    ...
                                    monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                ##
                                ## amination, methylation, phosphorylation
                                ##
                                elif hetID1 == 'NH2' and atom_name1 == 'N' and hetID2 in self.d_res.keys():
                                    bond = atom_name2[0]+','+'N'
                                    monomer1 = chain2+str(res_no2).zfill(4)+iCode2
                                    monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                elif hetID2 == 'NH2' and atom_name2 == 'N' and hetID1 in self.d_res.keys():
                                    bond = atom_name1[0]+','+'N'
                                    monomer2 = chain2+str(res_no2).zfill(4)+iCode2
                                    monomer1 = chain1+str(res_no1).zfill(4)+iCode1
                                ##
                                ...
                                ##
                                    ...
                                    monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                ## error
                                elif hetID1 in ['SER','THR','GLU','ASP','ASN'] or hetID2 in ['SER','THR','GLU','ASP','ASN']:
                                    print hetID1, hetID2, atom_name1, atom_name2
                                    notexpected
                                ##
                                ...
                                ## error
                                    ...
                                    hetID1 not in ['SIA','SLB',] and hetID2 not in ['SIA','SLB',]
                                ...
                                ##
                                ## 1,1-glycoside bond (e.g. trehalose)
                                elif int(atom_name1_no) == 1 and int(atom_name2_no) == 1 and len(set([hetID1,hetID2]) & set(['GOL'])) > 0:
                                    if atom_name1[0] == 'O' and atom_name2[0] == 'C':
                                        monomer1 = chain1+str(res_no1).zfill(4)+iCode1
                                        monomer2 = chain2+str(res_no2).zfill(4)+iCode2
                                    elif atom_name1[0] == 'C' and atom_name2[0] == 'O':
                                        monomer1 = chain2+str(res_no2).zfill(4)+iCode2
                                        monomer2 = chain1+str(res_no1).zfill(4)+iCode1
                                    else:
                                ...
                                if atom_name1 != 'SG' and atom_name2 != 'SG':
                                    ...
                                    if monomer2 in d_adjacency_forward[monomer1]: ## temp!!!
                                        if bond != d_adjacency_forward[monomer1][monomer2]: ## temp!!!
                                            print bond, d_adjacency_forward[monomer1][monomer2]
                                            print monomer1, monomer2
...
##        print d_molecules
    ...
    def parse_recordCONECT(self,line,d_atomnos,d_CONECT):
        ...
        if res_name1 in self.l_cofactors+self.l_solutes:
            return d_CONECT
        ...
        for atom_no2 in atom_nos[1:]:
            ...
            if atom_name2[0] == 'H':
                continue
            ## skip if a cofactor to which molecules are not *covalently* bound
            if res_name2 in self.l_cofactors+self.l_solutes:
                continue
            if (
                chain1 !=  chain2 or
                res_no1 != res_no2 or
...
##                        transformation = True
    ...
    def parse_recordATOM(self, line, d_pdb, lines, i, d_seq, s_pdb, record):
        ...
        ## temp!!!
            ...
            print s_pdb, chain, res_no, iCode, atom_altloc ## temp!!!
            print line
            stop
        ## check that res_name is correct (e.g. 2fes:L:1)
        elif d_pdb['chains'][chain]['residues'][res_no]['d_iCodes'][iCode]['res_name'] != res_name and atom_altloc == ' ': ## 1fh2:A:30 atom_altloc
...
########
            ...
            for iCode_prev in l_iCodes:
                print iCode_prev, iCode, l_iCodes
                if 'REMARK' in d_pdb['chains'][chain]['residues'][res_no]['d_iCodes'][iCode_prev].keys():
                    ATOMseq,d_res_nos = self.ATOM2seq(d_pdb, chain, res_no_max = res_no)
                    res_symbol = self.res_name2res_symbol(res_name)
                    if len(ATOMseq) > 0 and res_symbol == d_seq['chains'][chain]['seq'][len(ATOMseq)] and ATOMseq == d_seq['chains'][chain]['seq'][:len(ATOMseq)]:
                        l_iCodes = [iCode]+d_pdb['chains'][chain]['residues'][res_no]['l_iCodes']
                        d_pdb['chains'][chain]['residues'][res_no]['l_iCodes'] = l_iCodes
                    elif len(ATOMseq) == 0 and res_symbol != d_seq['chains'][chain]['seq'][0]:
                        d_pdb['chains'][chain]['residues'][res_no]['l_iCodes'] += [iCode]
                        l_iCodes = d_pdb['chains'][chain]['residues'][res_no]['l_iCodes']
                    else:
                        print res_symbol, d_seq['chains'][chain]['seq'][len(ATOMseq)]
                        print ATOMseq == d_seq['chains'][chain]['seq'][:len(ATOMseq)]
                        print 
                        print ATOMseq
                        print d_seq['chains'][chain]['seq']
                        print s_pdb, chain, res_no, iCode, iCode_prev, res_name
                        stop
                    break
########
...
##            'TPP', ## vitamin B1            
        ...
        ## none of the hetIDs appear in l_modres
        self.d_saccharides = {
            ##
