...
## this version deals with the inclusion of atoms other than alpha carbon atoms

## question to proceed if altlocs
...
## add a flag to know if std res is atom or hetatm
    ...
    def main(
        ...
        cutoff_distance = 10.,
        path_html = None, path_python = None, verbose = False, paralleldir = None,
        chains = [], model = None,
        ):
        ...
        l_coordinates, d_coordinates, d_hessian, l_CA = self.pre_hessian(d_coordinates, chains, atoms_hessian)
...
################################################################################
        ...
        fileprefix = jobid+'_overlapscombined_mode3N'
    ...
    def gnuplot_histogram(self, d_data, fileprefix):
        ...
        if os.path.isfile('gnuplot.ps') == False:
            stop
    ...
    def parse_pdb(self, lines, parse_model):
